...
do
  ...
  -- Configure clipboard provider for WSL2
  ...
  -- Do not soft-wrap long lines onto multiple display rows.
  -- NOTE: 'wrap' defaults to ON in Neovim/Vim, which is most visible in
  -- markdown/text files with long paragraph lines.
  vim.o.wrap = false
